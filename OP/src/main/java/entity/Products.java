...
public class Products extends Entity {
    ...
    private float speed = 2.0f; // Speed at which the product falls, why should we use float? firstly 2.0 is double literal instead 2.0f is a float literal and its more  beneficial bcs float occupies 4 bytes, and double 8 bytes
